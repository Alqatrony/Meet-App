 ...
 * update the calendar yourself. For more info, check out the SCOPES documentation at 
 * this link: https://developers.google.com/identity/protocols/oauth2/scopes
 */
...
const credentials = {
  ...
  redirect_uris: ["https://alqatrony.github.io/Meet-App/"],
  javascript_origins: ["https://alqatrony.github.io", "http://localhost:3000"],
};
...
/* The first step in the OAuth process is to generate a URL so users can log in with Google and be authorized 
 * to see your calendar. After logging in, they’ll receive a code as a URL parameter.
 */
